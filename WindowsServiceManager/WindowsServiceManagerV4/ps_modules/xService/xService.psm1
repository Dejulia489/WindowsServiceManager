...
$script:localizedData = Get-LocalizedData -ResourceName 'xService'
...
<#
    ...
    .NOTES
        ...
        Here are the paths through which Set-xService calls Invoke-CimMethod:

        Set-xService --> Set-ServicePath --> Invoke-CimMethod
...
function Test-xService
{
    ...
    $serviceResource = Get-xService -Name $Name
